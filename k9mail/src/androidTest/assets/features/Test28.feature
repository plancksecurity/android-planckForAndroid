Feature: Attachment_1.2.13_Send1FileTo1Contact
  ...
  Scenario: Test Attachment_1.2.14_Send4FilesTo3Contacts
    ...
    Then I send 1 message to bot with subject TestCase1.2.14 and body TestCase1.2.14
    And I click message compose
    Then I send 1 message to secondBot with subject TestCase1.2.14 and body TestCase1.2.14
    And I click message compose
    Then I send 1 message to thirdBot with subject TestCase1.2.14 and body TestCase1.2.14
    And I click message compose
    Then I fill messageTo field with bot
    Then I fill messageTo field with secondBot
    Then I fill messageTo field with thirdBot
