...
public class NotificationContentCreatorTest {
    ...
    private NotificationContentCreator createNotificationContentCreator() {
        ...
        Context contextSpy = stubContextSpy(context);
        return new NotificationContentCreator(contextSpy);
    }

    private Context stubContextSpy(Context context) {
        Context contextSpy = Mockito.spy(context);
        Mockito.doReturn("(No subject)").when(contextSpy).getString(R.string.general_no_subject);
        Mockito.doReturn("No sender").when(contextSpy).getString(R.string.general_no_sender);
        Mockito.doReturn("To:Bob").when(contextSpy).getString(R.string.message_to_fmt, "Bob");
        Mockito.doReturn("*Encrypted*").when(contextSpy).getString(R.string.preview_encrypted);
        return contextSpy;
    }
