...
public class CertificateErrorNotificationsTest {
    ...
    @Test
    public void testShowCertificateErrorNotificationForIncomingServer() {
    ...
    @Test
    public void testClearCertificateErrorNotificationsForIncomingServer() {
        int notificationId = NotificationIds.getCertificateErrorNotificationId(account, INCOMING);
    ...
    @Test
    public void testShowCertificateErrorNotificationForOutgoingServer() {
    ...
    @Test
    public void testClearCertificateErrorNotificationsForOutgoingServer() {
        int notificationId = NotificationIds.getCertificateErrorNotificationId(account, OUTGOING);
