...
public class WearNotificationsTest {
    ...
    public void setUp() throws Exception {
        ...
        NotificationController controller = createNotificationHelper(ApplicationProvider.getApplicationContext(), builder);
    ...
    @Test
    public void testBuildStackedNotificationWithDeleteActionEnabled() {
        enableDeleteAction();
        int notificationIndex = 0;
        int notificationId = NotificationIds.getNewMailStackedNotificationId(account, notificationIndex);
        MessageReference messageReference = createMessageReference(1);
    ...
    @Test
    public void testBuildStackedNotificationWithArchiveActionEnabled() {
        enableArchiveAction();
        int notificationIndex = 0;
        int notificationId = NotificationIds.getNewMailStackedNotificationId(account, notificationIndex);
        MessageReference messageReference = createMessageReference(1);
    ...
    @Test
    public void testBuildStackedNotificationWithMarkAsSpamActionEnabled() {
        enableSpamAction();
        int notificationIndex = 0;
        int notificationId = NotificationIds.getNewMailStackedNotificationId(account, notificationIndex);
        MessageReference messageReference = createMessageReference(1);
    ...
    @Test
    public void testAddSummaryActions() {
    ...
    @Test
    public void testAddSummaryActionsWithDeleteAllActionEnabled() {
        enableDeleteAction();
        int notificationId = NotificationIds.getNewMailSummaryNotificationId(account);
        ArrayList<MessageReference> messageReferences = createMessageReferenceList();
        NotificationData notificationData = createNotificationData(messageReferences);
    ...
    @Test
    public void testAddSummaryActionsWithArchiveAllActionEnabled() {
        enableArchiveAction();
        int notificationId = NotificationIds.getNewMailSummaryNotificationId(account);
        ArrayList<MessageReference> messageReferences = createMessageReferenceList();
        NotificationData notificationData = createNotificationData(messageReferences);
    ...
    private NotificationController createNotificationHelper(Context context, Builder builder) {
        NotificationController notificationHelper = mock(NotificationController.class);
