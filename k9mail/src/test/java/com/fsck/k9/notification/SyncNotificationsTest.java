...
public class SyncNotificationsTest {
    ...
    @Test
    public void testShowSendingNotification() {
    ...
    @Test
    public void testClearSendingNotification() {
        int notificationId = NotificationIds.getFetchingMailNotificationId(account);
    ...
    @Test
    public void testGetFetchingMailNotificationId() {
    ...
    private NotificationController createFakeNotificationController(
