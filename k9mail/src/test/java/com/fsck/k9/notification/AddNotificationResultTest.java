...
public class AddNotificationResultTest {
    ...
    @Test
    public void newNotification_shouldCancelNotification_shouldReturnFalse() {
    ...
    public void newNotification_getNotificationId_shouldReturnNotificationId() {
        AddNotificationResult result = AddNotificationResult.newNotification(notificationHolder);
    ...
    @Test
    public void replaceNotification_shouldCancelNotification_shouldReturnTrue() {
    ...
    @Test
    public void replaceNotification_getNotificationId_shouldReturnNotificationId() {
        AddNotificationResult result = AddNotificationResult.replaceNotification(notificationHolder);
    ...
    @Test
    public void getNotificationHolder_shouldReturnNotificationHolder() {
        AddNotificationResult result = AddNotificationResult.replaceNotification(notificationHolder);
