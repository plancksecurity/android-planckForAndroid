...
public class DeviceNotificationsTest {
    ...
    @Test
    public void buildSummaryNotification_withPrivacyModeActive() {
    ...
    @Test
    public void buildSummaryNotification_withSingleMessageNotification() {
    ...
    @Test
    public void buildSummaryNotification_withMultiMessageNotification() {
        K9.setNotificationHideSubject(NotificationHideSubject.NEVER);
        K9.setNotificationQuickDeleteBehaviour(NotificationQuickDelete.ALWAYS);
    ...
    @Test
    public void buildSummaryNotification_withAdditionalMessages() {
        K9.setNotificationHideSubject(NotificationHideSubject.NEVER);
        K9.setNotificationQuickDeleteBehaviour(NotificationQuickDelete.ALWAYS);
        when(notificationData.isSingleMessageNotification()).thenReturn(false);
    ...
    @Test
    public void buildSummaryNotification_withoutDeleteAllAction() {
        K9.setNotificationHideSubject(NotificationHideSubject.NEVER);
    ...
    @Test
    public void buildSummaryNotification_withoutDeleteAction() {
        K9.setNotificationHideSubject(NotificationHideSubject.NEVER);
        K9.setNotificationQuickDeleteBehaviour(NotificationQuickDelete.NEVER);
        when(notificationData.isSingleMessageNotification()).thenReturn(true);
