...
public class AuthenticationErrorNotificationsTest {
    ...
    @Test
    public void showAuthenticationErrorNotification_withIncomingServer_shouldCreateNotification() {
    ...
    @Test
    public void clearAuthenticationErrorNotification_withIncomingServer_shouldCancelNotification() {
        int notificationId = NotificationIds.getAuthenticationErrorNotificationId(account, INCOMING);
    ...
    @Test
    public void showAuthenticationErrorNotification_withOutgoingServer_shouldCreateNotification() {
    ...
    @Test
    public void clearAuthenticationErrorNotification_withOutgoingServer_shouldCancelNotification() {
        int notificationId = NotificationIds.getAuthenticationErrorNotificationId(account, OUTGOING);
