...
class PlanckExtraKeysPresenterTest {
    @get:Rule
    var coroutinesTestRule = CoroutineTestRule()

    private val view: PlanckExtraKeysView = mockk(relaxed = true)
    private val provider: PlanckProvider = mockk()
    private val preferences: Preferences = mockk()
    private val presenter = PlanckExtraKeysPresenter(
        provider,
        preferences,
