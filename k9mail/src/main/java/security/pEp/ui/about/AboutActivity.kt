    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbarCustomizer.setToolbarColor(
            ThemeManager.getToolbarColor(
                this,
                ThemeManager.ToolbarType.DEFAULT
            )
        )
        ...
        val documentationButton = findViewById<TextView>(R.id.documentation_button)
        documentationButton.setOnClickListener {
            startActivity(
                Intent(
                    Intent.ACTION_VIEW,
                    Uri.parse(getString(R.string.pEp_documentation_url))
                )
            )
        }
        documentationButton.paintFlags = documentationButton.paintFlags or Paint.UNDERLINE_TEXT_FLAG

        val librariesString = buildLibrariesHtml()
        val librariesText = findViewById<TextView>(R.id.librariesText)
        ...
        val licenseButton = findViewById<Button>(R.id.license_button)
        licenseButton.setOnClickListener { openLicenseActivity(this) }
        licenseButton.paintFlags = licenseButton.paintFlags or Paint.UNDERLINE_TEXT_FLAG
    }
    ...
    private fun buildAboutString(): String {
        ...
        val html = StringBuilder()
            ...
            .append(
                "<p>${
                    String.format(
                        getString(R.string.app_authors_fmt),
