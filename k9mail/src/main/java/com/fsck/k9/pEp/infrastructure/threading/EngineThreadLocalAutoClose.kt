...
class EngineThreadLocalAutoClose private constructor(private val k9: K9) : ThreadLocal<EngineInterface>(), AutoCloseable {
    ...
    companion object {
        ...
        private lateinit var instance: EngineThreadLocalAutoClose

        @JvmStatic
        fun getInstance(k9: K9): EngineThreadLocalAutoClose {
            synchronized(this) {
                if (!::instance.isInitialized) {
                    instance = EngineThreadLocalAutoClose(k9)
                }
            }
            return instance
        }
