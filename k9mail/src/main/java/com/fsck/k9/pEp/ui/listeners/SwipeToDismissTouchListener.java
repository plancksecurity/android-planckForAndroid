 ...
 * passing in the scroll listener returned by {@link #makeScrollListener(ScrollCallback)}. If a scroll listener is
...
public class SwipeToDismissTouchListener<SomeCollectionView extends ViewAdapter> implements
     ...
     */
    public Object makeScrollListener(final ScrollCallback scrollCallback) {
