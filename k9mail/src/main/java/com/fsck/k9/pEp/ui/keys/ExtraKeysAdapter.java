...
public class ExtraKeysAdapter extends RecyclerView.Adapter<ExtraKeysAdapter.ViewHolder> {
    ...
    public ExtraKeysAdapter(List<KeyListItem> identities, List<String> selectedKeys,
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void renderIdentity(final KeyListItem keyItem) {
            ...
            isBlacklistedCheckbox.setChecked(selectedKeys.contains(keyItem.getFpr()));
    ...
    private final SortedList.Callback<KeyListItem> sortedListCallback = new SortedList.Callback<KeyListItem>() {
        ...
        public void onInserted(int position, int count) {
            ExtraKeysAdapter.this.notifyItemRangeInserted(position, count);
        }

        @Override
        public void onRemoved(int position, int count) {
            ExtraKeysAdapter.this.notifyItemRangeRemoved(position, count);
        }

        @Override
        public void onMoved(int fromPosition, int toPosition) {
            ExtraKeysAdapter.this.notifyItemMoved(fromPosition, toPosition);
        }

        @Override
        public void onChanged(int position, int count) {
            ExtraKeysAdapter.this.notifyItemRangeChanged(position, count);
        }
