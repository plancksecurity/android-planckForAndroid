 ...
 */
public class ChooseFolderFilter<T> extends Filter {
    /**
     ...
     * @param folderNames
     */
    public ChooseFolderFilter(final ArrayAdapter<T> folderNames) {
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        ...
        try {
            ...
            if (folders != null) {
                ...
                Timber.w("ChooseFolderFilter.publishResults - null search-result ");
            }
