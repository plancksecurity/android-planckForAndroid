...
public abstract class PlanckImporterActivity extends PlanckActivity {
    ...
    public static class ListImportContentsAsyncTask extends ExtendedAsyncTask<Boolean, Void, Boolean> {
        ...
        public ListImportContentsAsyncTask(PlanckImporterActivity activity, Uri uri) {
            super(activity);
            mUri = uri;
        }
        ...
        protected void onPostExecute(Boolean success) {
            PlanckImporterActivity activity = (PlanckImporterActivity) mActivity;
        ...
        private void onPostExecuteImportSettings(PlanckImporterActivity activity, Boolean success) {
            if (success) {
    ...
    public static class SimpleDialog implements NonConfigurationInstance {
        ...
        public void restore(Activity activity) {
            show((PlanckImporterActivity) activity);
        }
        ...
        public void show(final PlanckImporterActivity activity) {
         ...
         */
        protected String generateMessage(PlanckImporterActivity activity) {
         ...
         *         The {@code Activity} this dialog belongs to.
         */
        protected void okayAction(PlanckImporterActivity activity) {
            // Do nothing
        }
    }
    ...
    public static class ImportSelectionDialog implements NonConfigurationInstance {
        ...
        @Override
        public void restore(Activity activity) {
            show((PlanckImporterActivity) activity, mSelection);
        }
        ...
        public void show(PlanckImporterActivity activity) {
            show(activity, null);
        }

        public void show(final PlanckImporterActivity activity, SparseBooleanArray selection) {
    ...
    private static class ImportAsyncTask extends ExtendedAsyncTask<Void, Void, Boolean> {
        ...
        private ImportAsyncTask(PlanckImporterActivity activity, boolean includeGlobals,
    ...
    public static class PasswordPromptDialog implements NonConfigurationInstance, TextWatcher {
        ...
        @Override
        public void restore(Activity activity) {
            show((PlanckImporterActivity) activity, true);
        }
        ...
        private void show(final PlanckImporterActivity activity, boolean restore) {
