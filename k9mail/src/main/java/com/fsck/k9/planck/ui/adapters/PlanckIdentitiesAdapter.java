package com.fsck.k9.planck.ui.adapters;
...
public class PlanckIdentitiesAdapter extends RecyclerView.Adapter<PlanckIdentitiesAdapter.ViewHolder> {
    ...
    public PlanckIdentitiesAdapter(List<Account> accounts, View.OnClickListener onResetGreenClick,
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        PlanckIdentity identity = identities.get(position);
    ...
    public PlanckIdentity get(int position) {
        return identities.get(position);
    }

    public List<PlanckIdentity> getIdentities() {
        return identities;
    }

    public void setIdentities(List<PlanckIdentity> identities) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        public void render(int position, PlanckIdentity identity) {
