...
class MistrustConfirmationDialog : EstablishTrustConfirmationDialog() {
    ...
    override val progressMessage: String
        get() = getString(R.string.reject_trust_dialog_progress, user)
    override val confirmationMessage: String
        get() = getString(R.string.reject_trust_dialog_confirmation, user)
    override val failureMessage: String
        get() = getString(R.string.reject_trust_dialog_failure, user)
    override val successMessage: String
        get() = getString(R.string.reject_trust_dialog_success, user)
