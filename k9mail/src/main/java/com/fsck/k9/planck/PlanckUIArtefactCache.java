 ...
 */
public class PlanckUIArtefactCache
{
    ...
    private static PlanckUIArtefactCache instance = null;
    ...
    public synchronized static PlanckUIArtefactCache getInstance(Context context) {
        if (instance == null) {
            instance = new PlanckUIArtefactCache(context);
        }
    ...
    private PlanckUIArtefactCache(Context context) {
    ...
    private void fillIndexMapping(Resources resources) {
        ...
        for(int idx=0; idx < colornames.length; idx ++) {
            colorIndexMapping.put( PlanckUtils.stringToRating(colornames[idx]), idx);
        }
    }
    ...
    public void setRecipients(Account account, ArrayList<Identity> recipients) {
        this.recipients = PlanckUtils.filterRecipients(account, recipients);
    }
