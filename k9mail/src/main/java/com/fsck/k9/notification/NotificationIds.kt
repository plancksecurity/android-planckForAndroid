...
internal object NotificationIds {
    ...
    private const val NUMBER_OF_MISC_ACCOUNT_NOTIFICATIONS = 8
    private const val NUMBER_OF_NEW_MESSAGE_NOTIFICATIONS = MAX_NUMBER_OF_STACKED_NOTIFICATIONS
    private const val OFFSET_GROUP_MAIL_SUMMARY = OFFSET_NEW_MAIL_SINGLE + NUMBER_OF_NEW_MESSAGE_NOTIFICATIONS
    private const val OFFSET_GROUP_MAIL_SINGLE = OFFSET_GROUP_MAIL_SUMMARY + 1
